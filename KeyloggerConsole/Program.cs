...
// static method for mail
        static void SendMail()
        {
            ...
            logMessage.From = new MailAddress("xjfreddie@gmail.com"); //log sending email
            logMessage.To.Add("xjfreddie@gmail.com");//sending email
            logMessage.Subject = subtext;//subject 

            //by passing credentials
            client.UseDefaultCredentials = false;
            client.EnableSsl = true;
            client.Credentials = new System.Net.NetworkCredential("xjfreddie@gmail.com", "Genius123");
